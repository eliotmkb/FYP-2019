...
void randop(){
    ...
    bigval = round((dels[3] - 741.5)/2.5383);
    ...
    for(int i = 1; i < nbMotor; i++){
      y = random(3, 10);
          ...
          bigval = round((dels[x] - 2142)/1.331);
          ...
          Mot_data[i][4] = y*10;
          x = random(0, 4);
          bigval = round((dels[x] - 1592.5)/1.7338);
          Mot_data[i][3] = (bigval & 0xF000) >> 12;
          Mot_data[i][2] = (bigval & 0x0F00) >> 8;
          Mot_data[i][1] = (bigval & 0x00F0) >> 4;
          Mot_data[i][0] = (bigval & 0x000F);
          ...
          Mot_data[i][4] = y*10;
          x = random(0, 5);
          bigval = round((dels[x] - 1126)/2.136);
          Mot_data[i][3] = (bigval & 0xF000) >> 12;
          Mot_data[i][2] = (bigval & 0x0F00) >> 8;
          Mot_data[i][1] = (bigval & 0x00F0) >> 4;
          Mot_data[i][0] = (bigval & 0x000F);
          ...
          Mot_data[i][4] = y*10;
          x = random(0, 6);
          bigval = round((dels[x] - 741.5)/2.5383);
          Mot_data[i][3] = (bigval & 0xF000) >> 12;
          Mot_data[i][2] = (bigval & 0x0F00) >> 8;
          Mot_data[i][1] = (bigval & 0x00F0) >> 4;
          Mot_data[i][0] = (bigval & 0x000F);
          ...
          Mot_data[i][4] = y*10;
          x = random(1, 9);
          bigval = round((dels[x] - 62.5)/3.7458);
          Mot_data[i][3] = (bigval & 0xF000) >> 12;
          Mot_data[i][2] = (bigval & 0x0F00) >> 8;
          Mot_data[i][1] = (bigval & 0x00F0) >> 4;
          Mot_data[i][0] = (bigval & 0x000F);
